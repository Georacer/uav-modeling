\begin{versionhistory}
	...
	\vhEntry{2.1}P2016-07-28}{GZP}{Finished all major code snippets, added references, various math fixes, added analysis on the effect of mass additions on CoM and matrix of inertia}
\end{versionhistory}