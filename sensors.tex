...
\begin{IEEEeqnarray}{rCl}
	\dot{u}_m &=& \frac{F_x}{m} - (-\sin \theta ~m g) \IEEEyesnumber \IEEEyessubnumber\\
	\dot{v}_m &=& \frac{F_y}{m} -  \sin \phi \cos \theta ~m g  \IEEEyessubnumber\\
	\dot{w}_m &=& \frac{F_z}{m} -  \cos \phi \cos \theta ~m g \IEEEyessubnumber
\end{IEEEeqnarray}
%
\begin{lstlisting}
